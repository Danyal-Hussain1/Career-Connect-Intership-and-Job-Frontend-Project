...
// Data defaults moved to `dataStore.js` (localStorage-backed)
// `dataStore.js` exposes helper functions like `getStudents`, `getCompanies`, `getJobs`, etc.

// ===== INITIALIZE DATA =====
function initializeData() {
    if (typeof window.initializeLocalDataStore === 'function') {
        window.initializeLocalDataStore();
        return;
    }

    // Fallback: ensure keys exist (empty arrays/objects)
